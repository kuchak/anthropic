"""
Timing analysis by SERIES TICKER (not sub-category).

This is the correct level of granularity since we've proven series ticker matters
enormously (e.g., KXNBAGAME was 100% while KXNBA3D was 21%).
"""
...
def main():
    print("=" * 100)
    print("TIMING ANALYSIS BY SERIES TICKER")
    print("=" * 100)
    print()
    ...
    print(f"  Loaded {len(api_df):,} API records")
    print()
    ...
    # Map to sub-categories for context
    ...
    # Save to CSV
    results_df.to_csv('timing_by_series_ticker.csv', index=False)

    print("=" * 140)
    print("RESULTS SAVED")
    print("=" * 140)
    print(f"✅ Saved to timing_by_series_ticker.csv ({len(results_df)} series tickers)")
    print()
    ...
    # Show NBA breakdown
    print("=" * 140)
    print("🏀 NBA BREAKDOWN BY SERIES TICKER")
    print("=" * 140)
    print()
