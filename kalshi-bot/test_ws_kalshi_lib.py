#!/usr/bin/env python3
"""
Test script for WebSocket monitor using kalshi-python-unofficial library
"""
...
async def main():
    ...
    logger.info("=" * 80)
    logger.info("Testing WebSocket Monitor (kalshi-python-unofficial)")
    logger.info("=" * 80)
    ...
    monitor = KalshiWebSocketMonitor(config, series_discovery)
    ...
    try:
        await monitor.run_monitor(on_market_triggered)
